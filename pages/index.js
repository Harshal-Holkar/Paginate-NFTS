...
const publicKey = 'Geh5Ss5knQGym81toYGXDbH3MFU2JCMK7E4QyeBHor1b';
...
const execute = async()=>{
  ...
  const changeCurrentPage = (operation) => {
    if(operation === 'next') setCurrentPage((prevValue) => prevValue + 1);
    else setCurrentPage((prevValue) => prevValue - 1);
  };
